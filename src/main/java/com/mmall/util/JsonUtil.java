...
public class JsonUtil {
    ...
    static{
        ...
        //取消默认转换timestamps形式，取消转换的时候默认把Date类型转换为timestamps格式，也就是时间戳，是从1970年1月1日到现在的毫秒数
        objectMapper.configure(SerializationConfig.Feature.WRITE_DATES_AS_TIMESTAMPS,false);

        //忽略空Bean转json的错误，false表示Bean中没有值的话就是一个空，不会报异常
    ...
    **/
    ...
    /**
      * @Author Yangh
      * @Description //TODO 返回格式化好的Json字符串，只是为了看得更清楚，平时使用上面的方法即可
    ...
    **/
    ...
    /**
      * @Author Yangh
      * @Description //TODO 将字符串转为对象，第一个<T>表示这是一个泛型方法
