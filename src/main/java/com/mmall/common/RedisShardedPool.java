...
public class RedisShardedPool {
    ...
    private static void initPool(){
        ...
        JedisShardInfo info1 = new JedisShardInfo(redis1Ip,redis1Port,1000*2);//不加超时时间，源码中默认的也是2秒
//        info1.setPassword();//如果redis设置有密码就执行此句
        ...
        //MURMUR_HASH就是hash一致性算法，不写默认就是这个算法
